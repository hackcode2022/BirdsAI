...
const selecti = document.getElementsByTagName('label')[0];
const textInput = document.getElementById('bs64');
...
function handleFile(file) {
    if (file) {
        ...
        reader.onload = function (e) {
            ...
            selecti.innerHTML = "Sélectionner une autre image";
